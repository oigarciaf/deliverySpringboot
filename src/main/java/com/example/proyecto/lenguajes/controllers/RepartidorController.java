...
public class RepartidorController {
    ...
    @PutMapping("/{id}/asignarpedido")
    public ResponseEntity<Repartidor> asignarPedido(@PathVariable Integer id, @RequestBody Orden orden) { 
        try {
            Repartidor repartidor = repartidorServiceImpl.asignarOrden(id, orden);
            return new ResponseEntity<>(repartidor, HttpStatus.OK);
