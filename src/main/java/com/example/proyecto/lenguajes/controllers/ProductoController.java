...
public class ProductoController {
	...
	//private String rutaImagenes = "src/main/java/com/example/proyecto/lenguajes/imagenes";
    ...
    public ResponseEntity<String> delete(@PathVariable Integer id) {
        ...
        if (optionalProducto.isPresent()) {
            ...
            /*
            if (!producto.getImagen().equals("piolin.jpg")) {
                boolean imagenEliminada = eliminarImagen(producto.getImagen());
                if (!imagenEliminada) {
                    return ResponseEntity.badRequest().body("No se pudo eliminar la imagen del producto.");
                }
            }
            */
    ...
    private String subirImagen(MultipartFile archivo) throws IOException {
        return guardarimagenservice.saveImage(archivo);
    }
    */
